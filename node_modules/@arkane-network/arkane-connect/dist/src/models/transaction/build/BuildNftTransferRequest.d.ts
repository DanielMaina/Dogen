...
export declare class BuildNftTransferRequest extends BuildTransferRequestBase implements BuildNftTransferRequestDto {
    tokenAddress: string;
    tokenId: string;
    from?: string;
    amount?: number;
    static fromData(requestData: BuildNftTransferRequestDto): BuildNftTransferRequest;
